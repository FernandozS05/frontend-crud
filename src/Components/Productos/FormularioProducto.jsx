  ...
  return (
    <div className="p-6 border border-red-400 rounded">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <label className="block font-medium text-red-700">Nombre:</label>
          <input
            type="text"
            name="name"
            value={producto.name}
        ...
        <div className="mb-4">
          <label className="block font-medium text-red-700">Precio:</label>
          <input
            type="number"
            name="price"
        ...
        <div className="mb-4">
          <label className="block font-medium text-red-700">Categoría:</label>
          <select
            name="category"
        ...
        <div className="flex gap-4">
          ...
          <button
            type="button"
            className="flex items-center gap-2 bg-gray-600 text-white font-bold px-4 py-2 rounded hover:bg-gray-700"
